package com.utoo.android.tools.io;
...
public class FileUtil {
    ...
    public final int MODE_APPEND = 1;
    public final int MODE_NEW = 2;
     ...
     * @throws Exception
     */
    public static void write2file(String filename, String content,int mode) throws Exception {
     ...
     * @throws Exception
     */
    public static void write2file(String filename, byte[] content,int mode) throws Exception {
        File file = new File(filename);
        File parentFile = file.getParentFile();
        if ((parentFile.mkdirs() || parentFile.isDirectory())) {
            if (file.exists()) file.delete();//如果文件已经存在，则删除该文件
